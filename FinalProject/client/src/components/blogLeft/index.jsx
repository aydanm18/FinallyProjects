  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="contactus">
            ...
            <div className="contact-links">
              <span><Link className='links' to={'/'}>Home / </Link>Blog Left</span>
            </div>
          </div>
      ...
      <div id='blogleft'>
        <div className="container">
         <div className="row">
           <div data-aos="fade-right" className="col-4 col-md-6 col-sm-12 col-xs-12 blogrigth">
            <form >
          ...
          <div data-aos="fade-left" className="col-8 col-md-6 col-sm-12 col-xs-12">
              <div className="box">
                <div className="img">
